...
public class CPUtypeB_alt {
	private PriorityQueue<Process> readyQueue = new PriorityQueue<Process>(100,new priorityAO());
			...
			if(!readyQueue.isEmpty()) {
				...
				while(currentRunning.getRemainingTime()>0) {
					...
					if(interval == 0 && processCount < 95) {
						...
						processCount++;
						Process tempProcess = newProcess();
						if(tempProcess.getPriority() > currentRunning.getPriority()) {
